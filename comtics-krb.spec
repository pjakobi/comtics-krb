...
#
Summary: MIT Kereros configuration for COMTICS
Name: comtics-krb
...
Source0: http://github.com/pjakobi/comtics-iam/archive/%{version}.%{release}.tar.gz
...
%description
This rpm customizes openldap for the needs of the COMTICS project.
